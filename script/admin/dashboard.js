...
const PAGE_MODULES = {
  'gallerie.php': { path: '/script/admin/gallerie_dahsboard.js', initFunction: 'initGallery', destroyFunction: 'destroyGallery' },
  'faq.php': { path: '/script/admin/faq_dashboard.js', initFunction: 'initFaq', destroyFunction: 'destroyFaq' },
  'actualites.php': { path: '/script/admin/actualites_dashboard.js', initFunction: 'initActualites', destroyFunction: 'destroyActualites' },
  'admin.php': { path: '/script/admin/adminProfil_dashboard.js', initFunction: 'initAdminProfilDashboard', destroyFunction: 'destroyAdminProfilDashboard' },
  'club.php': { path: '/script/admin/club_dahsboard.js', initFunction: 'initClub', destroyFunction: 'destroyClub' },
  'partenaires.php': { path: '/script/admin/partenaires_dashboard.js', initFunction: 'initPartenairesDashboard', destroyFunction: 'destroyPartenairesDashboard' },
  'dashboard-accueil.php': { path: '/script/admin/accueil_dashboard.js', initFunction: 'initDashboardAccueil', destroyFunction: 'destroyDashboardAccueil' },
  'events.php': { path: '/script/admin/event_dashboard.js', initFunction: 'initEventsDashboard', destroyFunction: 'destroyEventsDashboard' },
  'messagerie.php': { path: '/script/admin/messagerie_dahsboard.js', initFunction: 'initMessagerieDashboard', destroyFunction: 'destroyMessagerieDashboard' },
  'palmares.php': { path: '/script/admin/palmares_dashboard.js', initFunction: 'initPalmaresDashboard', destroyFunction: 'destroyPalmaresDashboard' },
  'informations.php': { path: '/script/admin/informations_dashboard.js', initFunction: 'initInformationsDashboard', destroyFunction: 'destroyInformationsDashboard' },
  'equipes.php': { path: '/script/admin/equipes_dashboard.js', initFunction: 'initEquipesDashboard', destroyFunction: 'destroyEquipesDashboard' },
};
